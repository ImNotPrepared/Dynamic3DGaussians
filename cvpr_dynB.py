...
def train(seq, exp):
    ...
    #    return
    md = json.load(open(f"/data3/zihanwa3/Capstone-DSR/Processing/scripts/Dy_train_meta.json", 'r'))  # metadata
    ...
    reversed_range = list(range(0, 100, 3))
