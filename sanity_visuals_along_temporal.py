...
# Step 2: Apply PCA to the collected dataset
  ...
  for ts in tqdm(range(123, 423), desc=f"Visualizing features for cam {cam_id}"):
      ...
      # Save the image
      base_base_path = f'/data3/zihanwa3/Capstone-DSR/Processing/dinov2features/pca_aligned_temporal/{cam_id}'
